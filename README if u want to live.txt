...
- Most Importantly: if you REALLY cant have much of the program's namespace being global. You can still declare global variables and such the same way, but global or not, they will simply always be global to any code below it.
- if youre in a system that it just wouldnt really meld with. you gotta make that call yourself
