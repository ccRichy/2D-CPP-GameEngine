...
//IMAGES
void
draw_bmp(BMP_File* bmp, Vec2 pos, Vec2 scale)
{
...
void
draw_bmp_part(BMP_File* bmp, Vec2 pos, Vec2 scale_overall, int32 bmp_drawx, int32 bmp_drawy, int32 bmp_draw_width, int32 bmp_draw_height)
{
    //NOTE: this code was partially generated by ai
    Game_Render_Buffer* render = game_pointers->render;
    float32 draw_scale = game_get_draw_scale();
...
void
draw_bmp_1sttry(BMP_File* bmp, Vec2 pos)
{
    Game_Render_Buffer* render = game_pointers->render;
    int32 scale = (int32)game_pointers->settings->window_scale;
...
void
draw_bmp_pixels(BMP_File* bmp, Vec2 pos)
{
    pos.y += bmp->height;
    uint32* bitmap_pixel = (uint32*)((uint8*)bmp + bmp->offset);
